...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_ZW_GET_VERSION" ).setPriority ( 0.0 ) );
}
...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_ZW_MEMORY_GET_ID" ).setPriority ( 0.0 ) );
}
...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_ZW_GET_CONTROLLER_CAPABILITIES" ).setPriority ( 0.0 ) );
}
...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_SERIAL_API_GET_CAPABILITIES" ).setPriority ( 0.0 ) );
}
...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_ZW_GET_SUC_NODE_ID" ).setPriority ( 0.0 ) );
}
...
{
    zwDriver.get ().sendMsg ( new zwMsg ( 0xff, zwDefs.REQUEST, "FUNC_ID_SERIAL_API_GET_INIT_DATA" ).setPriority ( 0.0 ) );
}
...
{
    var msg = new zwMsg ( nodeId, zwDefs.REQUEST, "FUNC_ID_ZW_GET_NODE_PROTOCOL_INFO", null, cb ).setPriority ( 0.0 );
