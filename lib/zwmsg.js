...
var Msg = zwClass ( {
    initialize: function ()
    {
        ...
        this.buff = undefined;
            ...
            // TODO now that these helper initializers have matching args, we should be
    ...
    _initializeRequest: function ( nodeId, msgType, func, buff, cb )
    {
        log ( "Msg._initializeRequest called!".cyan );
...
//        msgType = zwDefs[ msgType ];
    ...
    _initializeResponse: function ( nodeId, msgType, func, buff, cb )
    {
        log ( "Msg._initializeResponse called!".cyan );
